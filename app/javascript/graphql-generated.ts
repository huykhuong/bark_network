...
export type Query = {
  ...
  posts: PostPage;
  /** Returns a list of reactions for a post */
...
export type Reaction = {
  __typename?: 'Reaction';
  id: Scalars['ID']['output'];
  isCurrentUserReaction: Scalars['Boolean']['output'];
...
export type AddReactionMutation = { __typename?: 'Mutation', addReaction?: { __typename?: 'AddReactionPayload', errors?: Array<string> | null, reaction?: { __typename?: 'Reaction', id: number, name: string, userDisplayName: string, isCurrentUserReaction: boolean } | null } | null };
...
export type DeleteCommentMutation = { __typename?: 'Mutation', deleteComment?: { __typename?: 'DeleteCommentPayload', success: boolean } | null };
...
export type RemoveReactionMutation = { __typename?: 'Mutation', removeReaction?: { __typename?: 'RemoveReactionPayload', success: boolean } | null };
...
export type GetPostReactionsQuery = { __typename?: 'Query', reactions: Array<{ __typename?: 'Reaction', id: number, isCurrentUserReaction: boolean, name: string, userDisplayName: string }> };
...
export const RemoveReactionDocument = gql`
    mutation removeReaction($postId: ID!, $id: ID!, $userId: ID!) {
  removeReaction(postId: $postId, id: $id, userId: $userId) {
    success
  }
}
    `;
...
export const GetPostReactionsDocument = gql`
...
/**
 * __useGetPostReactionsQuery__
 *
 * To run a query within a React component, call `useGetPostReactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPostReactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPostReactionsQuery({
 *   variables: {
 *      postId: // value for 'postId'
 *   },
 * });
 */
export function useGetPostReactionsQuery(baseOptions: Apollo.QueryHookOptions<GetPostReactionsQuery, GetPostReactionsQueryVariables> & ({ variables: GetPostReactionsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPostReactionsQuery, GetPostReactionsQueryVariables>(GetPostReactionsDocument, options);
      }
export function useGetPostReactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPostReactionsQuery, GetPostReactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPostReactionsQuery, GetPostReactionsQueryVariables>(GetPostReactionsDocument, options);
        }
export function useGetPostReactionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetPostReactionsQuery, GetPostReactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPostReactionsQuery, GetPostReactionsQueryVariables>(GetPostReactionsDocument, options);
        }
export type GetPostReactionsQueryHookResult = ReturnType<typeof useGetPostReactionsQuery>;
export type GetPostReactionsLazyQueryHookResult = ReturnType<typeof useGetPostReactionsLazyQuery>;
export type GetPostReactionsSuspenseQueryHookResult = ReturnType<typeof useGetPostReactionsSuspenseQuery>;
export type GetPostReactionsQueryResult = Apollo.QueryResult<GetPostReactionsQuery, GetPostReactionsQueryVariables>;
