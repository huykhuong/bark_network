...
const FriendCard: FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full flex items-center gap-4 pt-0 pb-8 mx-0 overflow-hidden bg-transparent shadow-none rounded-xl bg-clip-border">
        <img
        ...
        <div className="flex w-full flex-col gap-0.5">
          <div className="flex items-center justify-between">
            <h5 className="w-24 block font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-slate-800 text-ellipsis overflow-hidden">
              {displayName}
            </h5>
          </div>
